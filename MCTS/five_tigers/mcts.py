...
class TreeNode():
    ...
    def __init__(self, board, parent): # board is a class(scores,player,board,valid actions,move), parent is a node
...
class MCTS():
    ...
    def expand(self, node):
        ...
        for action in actions:
            ...
            if action not in node.children:
                ...
                # add child node to parent's node children dict
    ...
    def rollout(self, board):
        current = -board.player # who played this turn
        ...
        if board.check_winner() == current: return 1
        elif board.check_winner() == -current: return -1
        else: return 0.5
